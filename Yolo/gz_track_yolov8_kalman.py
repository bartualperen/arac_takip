...
# --- ANA PROGRAM ---
def main():
    TOPIC_NAME = "/world/sonoma/model/iris_with_gimbal/link/downward_camera_link/sensor/downward_camera/image"
    HEDEF_GORSEL = './Tubitak/track_nadir.png'
    MODEL_PATH = './Tubitak/best.pt'
    ...
    SKIP_FRAMES = 5
    CONF_THRESHOLD = 0.40
    RESNET_SIMILARITY = 0.80
    IOU_THRESHOLD = 0.5
    prev_time = time.time()

    pencere_adi = 'Gazebo Canli Takip Sistemi'
